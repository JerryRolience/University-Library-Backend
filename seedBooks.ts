...
//     // Return the exact URL format that ImageKit provides
//     return response.filePath; // This will be like "/books/covers/filename.jpg"
//   } catch (error) {
...
//     const booksWithImageKitUrls = await Promise.all(
//       bookData.map(async (book) => {
//         const coverUrl = await uploadToImageKit(
//           book.coverUrl,
//           `${book.title}-cover.${book.coverUrl.split(".").pop()}`, // Preserve original extension
//           "/books/covers"
//         );

//         const videoUrl = await uploadToImageKit(
//           book.videoUrl,
//           `${book.title}-video.${book.videoUrl.split(".").pop()}`, // Preserve original extension
//           "/books/videos"
//         );
...
//     const seededBooks = await Book.insertMany(booksWithImageKitUrls);
//     console.log(
//       `Successfully seeded ${seededBooks.length} books with ImageKit URLs`
//     );

//     // Sample output to verify format
//     console.log("Sample book URL format:", seededBooks[0].coverUrl);
